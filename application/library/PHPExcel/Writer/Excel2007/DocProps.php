...
/**
	 ...
	 */
	public function writeDocPropsApp(PHPExcel_PHPExcel $pPHPExcel = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function writeDocPropsCore(PHPExcel_PHPExcel $pPHPExcel = null)
	{
		// Create XML writer
		$objWriter = null;
		if ($this->getParentWriter()->getUseDiskCaching()) {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	public function writeDocPropsCustom(PHPExcel_PHPExcel $pPHPExcel = null)
	{
