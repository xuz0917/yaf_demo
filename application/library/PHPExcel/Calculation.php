...
class PHPExcel_Calculation {
	...
	private function __construct(PHPExcel_PHPExcel $workbook = NULL) {
	 ...
	 */
	public static function getInstance(PHPExcel_PHPExcel $workbook = NULL) {
		if ($workbook !== NULL) {
	 ...
	 */
	public static function unsetInstance(PHPExcel_PHPExcel $workbook = NULL) {
		if ($workbook !== NULL) {
    		if (isset(self::$_workbookSets[$workbook->getID()])) {
