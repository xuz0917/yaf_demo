...
function MDIOpen(url, nActiveMode) {
    ...
    var nw = main_right.document.createElement("iframe");
    nw.width = "100%";
    nw.height = document.body.offsetHeight - 60 - 26 - 28; //142
...
function ShowMainsgourl(lefturl) {
    var objLeft = window.frames['left'];
    if (lefturl != "") {
        objLeft.location.href = lefturl;
    }
    MDILoadurl("Public/loading.htm");
}
