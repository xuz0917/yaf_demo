...
/*
*       cms 后台默认首页的脚本 home.js
*       写于 2010-08-28 17:10:01
*       基于jquery-1.4.2.min.js
*/
...
function best_GetDate() {
    ...
    setInterval(function () {
        ...
        $$(rnd).innerHTML = new Date().toLocaleString() + " 星期" + "日一二三四五六".charAt(new Date().getDay()) + " " + holiday + " " + CnDateofDateStr(today) + " " + SolarTerm(today);
    }, 1000);
}
